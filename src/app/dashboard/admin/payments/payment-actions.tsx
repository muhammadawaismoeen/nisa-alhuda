/**
 * Payment Actions — receipt lightbox viewer + approve/reject for payment ledger.
 * Features full-screen image lightbox for receipt screenshots.
 */
"use client";
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        {status === "pending" && (
          <>
            ...
            >
              <DialogTrigger
                className="inline-flex shrink-0 items-center justify-center rounded-lg bg-destructive/10 text-destructive hover:bg-destructive/20 h-8 gap-1 px-2.5 text-xs font-medium transition-all"
              >
              ...
              <DialogContent>
                ...
                <div className="space-y-4 mt-2">
                  <p className="text-sm text-muted-foreground">
                    The student will see this reason on their enrollment status.
                  </p>
                  <Input
